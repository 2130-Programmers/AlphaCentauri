...
public class driveTrainSubsystem extends Subsystem {
    ...
    public boolean shiftingSetting;
    private int I;
    ...
    public driveTrainSubsystem() {
        ...
        leftMotorSlave = new WPI_TalonSRX(3);
        ...
        rightMotorSlave = new WPI_TalonSRX(1);
    ...
    public void runMotors() {
        differentialDrive.arcadeDrive(Robot.oi.driverJoystick.getRawAxis(-1), 
                                      Robot.oi.driverJoystick.getRawAxis(4));
    }
    public void shiftingForward() {
        shiftingSolenoid.set(Value.kForward);
    }
    public void shiftingReverse() {
        shiftingSolenoid.set(Value.kReverse);
    }
    public void shiftingPosition() {
        if(shiftingSetting) {
            shiftingForward();
        }else{
            shiftingReverse();
    ...
    public void setShiftingBoolean() {
        if(I == 0 && Robot.oi.shifterPositionValue()) {
            shiftingSetting = !shiftingSetting;
            I++;
        }else if(!Robot.oi.shifterPositionValue()) {
            I = 0;
        }
        
    }
    public void startShifterPosition() {
        shiftingSetting = true;
        shiftingForward();
    }
}
