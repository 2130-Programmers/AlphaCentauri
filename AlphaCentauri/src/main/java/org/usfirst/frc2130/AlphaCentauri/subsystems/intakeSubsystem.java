...
public class intakeSubsystem extends Subsystem {
    ...
    public intakeSubsystem() {
        ...
        leftRollerMotor = new VictorSP(0);
        addChild("leftRollerMotor",leftRollerMotor);
        leftRollerMotor.setInverted(false);
        
        rightRollerMotor = new VictorSP(1);
        addChild("rightRollerMotor",rightRollerMotor);
        rightRollerMotor.setInverted(false);
