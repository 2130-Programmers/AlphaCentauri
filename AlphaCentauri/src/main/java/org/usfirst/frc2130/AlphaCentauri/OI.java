...
public class OI {
    ...
    public OI() {
        ...
        switchDrivingButton = new JoystickButton(driverJoystick, 1);
        switchDrivingButton.whileHeld(new drivingConditionalCommand());
        switchPipelineBooleanButton = new JoystickButton(driverJoystick, 1);
        switchPipelineBooleanButton.whenPressed(new swtichPipelineBooleanCommand());
        switchPipelineButton = new JoystickButton(driverJoystick, 1);
        switchPipelineButton.whenReleased(new driverPipelineCommand());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("driverPipelineCommand", new driverPipelineCommand());
        SmartDashboard.putData("swtichPipelineBooleanCommand", new swtichPipelineBooleanCommand());
        SmartDashboard.putData("limelightPipelineCommand", new limelightPipelineCommand());
